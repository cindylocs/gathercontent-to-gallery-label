...
<body>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
			...
			if(ctype_digit($gcitem)){
				...
				$functional_description_left = $response["data"]["config"][0]["elements"][2]["value"];
				$functional_description_right = $response["data"]["config"][0]["elements"][3]["value"];
				...
				<div class="container">
					...
					<div class="custom-row" style="width:100%;">
						<div class="custom-column funcdesc" style="width:48%; float:left;">
									<?php
										if (!empty($functional_description_left)) {
										    print $functional_description_left;
										}
									?>	
						</div>
						<div class="custom-column funcdesc" style="width:48%; float:right;">
									<?php
										if (!empty($functional_description_right)) {
										    print $functional_description_right;
										}
									?>
						</div>
					</div>
